...
public class DateUtils {
	...
	* @author lis
	* @param @param d
	* @param @param param 格式化参数
	* @param @return 
	* @return Date 
	* @throws 
	*/ 
	public static Date parseDate(String d,String param) {
		try {
			return new SimpleDateFormat(param).parse(d);
		} catch (Exception e) {
		}
		return null;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(u.parseDate("2014-11-11 星期二","yyyy-MM-dd EEE"));
	}
