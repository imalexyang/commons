 ...
 * {@code UUID}. The bit layout described above is valid only for a {@code UUID}
 * with a variant value of 2, which indicates the Leach-Salz variant.
 * 
 * <p>
 * The version field holds a value that describes the type of this {@code UUID}.
 ...
 * 
 * <p>
 * For more information including algorithms used to create {@code UUID}s, see
 * <a href="http://www.ietf.org/rfc/rfc4122.txt"> <i>RFC&nbsp;4122: A
